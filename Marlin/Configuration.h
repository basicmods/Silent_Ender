...
#define STRING_CONFIG_H_AUTHOR "basicmods, Ender-3 Silent)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Silent Ender 3 Pro"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10, -2.40 }
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (5500)
